  ...
  messagesByChannel: {
    c2: [
      ...
      { id: "m4", author: members.ravi, at: t(18), text: "Monospace channel glyphs are the detail that sells it for me." },
      {
        ...
        embed: {
          url: "https://aiic.club/docs/design-tokens",
          domain: "aiic.club",
          title: "Design tokens — spacing, radius, and type scale",
          description: "The single source of truth for every surface in AIIC. 4px grid, 1px rules, two font roles.",
        },
      },
      {
        id: "m4c",
    ...
    c12: [
      {
        ...
        blocks: [
          { id: "b1", type: "p", text: "How we build, review, and ship AIIC. Start here." },
      ...
      },
      {
        ...
        blocks: [
          { id: "b1", type: "p", text: "Deploying and operating an AIIC instance." },
          { id: "b2", type: "code", text: "docker-compose up -d\ndocker-compose logs -f aiic" },
